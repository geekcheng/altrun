...
Begin
  ...
  hlParser.Resume;
  hlWriter.Resume;
  While (not hlWriter.FExecuting) do sleep(5);              // Sergue?
...
// -1-> Returns ?TStringList, with items like 'vType : vValue[,details]'
...
Begin
  Result := TStringList.Create;
  TRY
    // utilise heapRec transtyp?si aliment? sinon GetFirstEntry
    If HeapRec <> -1 Then
    Begin
